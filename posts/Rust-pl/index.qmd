...
*RustDoc* Generating documents embedded in rust source code via '///' then rendering on Doc.rs
 ...
 Because rust is a system programming language it supports condtional compilation,staticlib,dynamic link library .
